                                        ...
                                        Forms\Components\Placeholder::make('notes')
                                            ...
                                            ->content(function (Prospection $record): HtmlString {
                                                ...
                                                $notesList = $notes->map(function ($note) {
                                                    return '<span class="text-violet-500 hover:text-violet-700 font-bold uppercase">' . Carbon::parse($note['date'])->format('d/m/Y H:i')  . ' - Por: ' . $note['author'] . ' - ' . $note['annotation'] . '</span>';
